      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-20">
          ...
          >
            ...
            <p className="text-on-surface/60 text-body-lg max-w-2xl mx-auto font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                <Card className="h-full bg-surface-container border-border-outline-variant hover:border-primary/50 transition-all group backdrop-blur-sm rounded-lg overflow-hidden relative">
