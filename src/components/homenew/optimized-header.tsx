  ...
  return (
    <HeaderContainer>
      ...
      <Link href="/" className="flex items-center space-x-2 sm:space-x-3 group shrink-0 min-w-0" aria-label="Volver al inicio desde la cabecera">
        <div className="relative w-8 h-8 sm:w-10 sm:h-10 rounded flex items-center justify-center transition-all group-hover:rotate-6 group-hover:scale-110">
      ...
      <nav className="hidden lg:flex items-center space-x-2 bg-surface-variant/80 backdrop-blur-md border border-outline-variant rounded p-1.5 shadow-sm">
        <ActiveLink 
          href="/" 
        ...
        <Button
          asChild
          className="px-6 rounded bg-primary text-primary-foreground hover:bg-primary/95 font-display text-xxs font-semibold uppercase tracking-wider hover:scale-105 transition-transform shadow-sm"
        >
      ...
      <div className="flex items-center gap-4">
        <a href="tel:+5492236602699" aria-label="Llamar al +54 223 660-2699" className="hidden xl:flex items-center gap-3 px-5 py-2.5 rounded bg-surface-variant text-foreground border border-outline-variant text-xxs font-bold tracking-[0.1em] hover:text-primary hover:bg-surface-variant/80 transition-all uppercase active:scale-[0.95]">
