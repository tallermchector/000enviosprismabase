    ...
    <section className="py-12 md:py-16 bg-surface">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-xl md:max-w-3xl mx-auto text-center">
          <Badge variant="outline" className="mb-3 md:mb-4 text-xs sm:text-sm py-1 px-3 font-sans border-outline-variant text-on-surface-variant">
            Transparencia de Precios
          </Badge>
          <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4 md:mb-6 font-display">
            ¿Cómo Calculamos el Precio?
          </h2>
          <p className="text-lg md:text-xl text-on-surface-variant mb-8 md:mb-10 font-sans">
            Nuestros precios se basan en la distancia. Queremos que siempre sepas qué estás pagando.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-start">
          <Card className="bg-surface-container border border-outline-variant transition-all duration-300 ease-out hover:shadow-xl hover:-translate-y-1">
            <CardHeader>
            ...
            <CardContent className="font-sans">
              ...
              <ul className="mt-3 space-y-1.5 text-xs md:text-sm text-on-surface-variant list-disc list-inside">
