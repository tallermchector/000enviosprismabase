...
def main():
    ...
    # Ensure target directory docs/estructura exists
    ...
    for page_path in pages:
        ...
        print(f"Scanning page: {page_path} (Route: {route}) -> Writing to: {filename}")
    ...
    print(f"\nSuccess! All individual page structures written to: {os.path.relpath(dest_dir, root_dir)}")
